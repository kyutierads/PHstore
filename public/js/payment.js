...
$(function() {
    ...
    $(
        `<button class="btn btn-primary" role="button" aria-disabled="true" id="create" data-toggle="modal" data-target="#modal">Add Payment Methods</button>`
    ).insertAfter("#paymentTable_wrapper");
});
